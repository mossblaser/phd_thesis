\chapter{Conclusions and future research}
	...
	\section{Closing remarks}
		...
		SpiNNaker machines, largely because they do not yet exist, a number of
		smaller scale neural simulations have been made possible for the first
		time. The algorithms and techniques devised in this work have subsequently
		been incorporated into various software libraries and tools now being used
		by researchers building SpiNNaker applications, vindicating the efforts of
