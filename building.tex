	...
	\section{A SpiNNaker case study}
		...
		\subsection{Installation practicality}
			...
			\begin{figure}
				...
				\caption[$\approx \pi$ Interactive wiring software guides cable installation.]%
				{Interactive wiring software guides cable installation.}
			...
			cable in real-time ensuring mistakes are highlighted and fixed
			immediately.
