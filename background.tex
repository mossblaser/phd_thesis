\chapter{The SpiNNaker Architecture}
	...
	\section{Neural simulation}
		...
		LIF-like neurons does not arise from the cost of modelling neurons but
	...
	\section{Network architecture}
		...
		LIF are inexpensive to model and many neurons can be simulated
	...
	%     * Router
		...
		`instantaneously', in a real-time simulation the time at which a spike is
		produced is implicitly indicated by the time it is received.
	...
	\section{Scaling-up SpiNNaker machines}
		...
		appendix~\ref{sec:partitioning}) which logically fit together as
		illustrated in figure~\ref{fig:threeboard-separate}. The labelled exposed
		corners of the three forty-eight chip boards connect together to form a
		$12\times12$ hexagonal torus topology as illustrated in
