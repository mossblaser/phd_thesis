\chapter{The SpiNNaker Architecture}
	...
	\section{The SpiNNaker router}
		...
		\subsection{Routing tables}
			...
			on the right. By assigning routing keys such that neurons whose spikes
			are sent to similar destinations share a similar prefix, the number of
	...
	\section{The hexagonal torus topology}
		...
		topology drawn flat. If the topology is rolled up into a tube such that the
		top and bottom nodes become directly adjacent, a tube is formed as in
		figure~\ref{fig:torus-3d-tube}. This tube can then be bent to bring
		together the nodes at the ends of the tube to form a torus as shown in
		figure~\ref{fig:torus-3d-torus}.
