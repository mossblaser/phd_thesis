\chapter{Finding shortest path vectors in SpiNNaker's network}
	...
	This chapter tackles the problem of finding shortest path vectors in hexagonal
	...
	\section{Related work}
		...
		\subsection{Hexagonal torus networks}
			...
			\subsubsection{XYZ-Protocol}
				...
				the XYP-protocol uses just one for destinations in quadrant 1 or 4 and
				no more than three in quadrant 2 or 3. Though the XYZ-protocol can be
				computed more cheaply than the INSEE method, it does not produce valid
				shortest path vectors for hexagonal torus topologies with aspect ratios
				other than $1:1$.
