\chapter{Fault tolerant routing for SpiNNaker}
	...
	\section{Related work}
		...
		\subsection{Fault-tolerant routing}
			...
			The Immucube hybrid approach is similar to the technique I propose in
	...
	\section{Evaluation \& Results}
		...
		\subsection{Traffic Patterns}
			...
			\begin{figure}
				...
				sent by the node at the position marked with an $\times$ to nodes
				chosen randomly with nodes in lighter areas being selected with a
				higher probability.}
			...
			\begin{description}
				...
				\item[3-centroids] Destinations are clustered around one of 3
