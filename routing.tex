\chapter{Fault tolerant routing for SpiNNaker}
	...
	\section{Evaluation and results}
		...
		\subsection{Traffic patterns}
			...
			sinks. Fan out does not have a significant impact on the performance of
			PGS repair and so I have simplified this evaluation by only considering
			routes with a single source node and sixteen sink nodes.
