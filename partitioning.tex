\chapter{Partitioning hexagonal toruses}
	...
	\section{Tiling}
		...
		of the parallelograms matches that of the pointy-topped hexagons. I refer to
	...
	\section{Triads of triples}
		...
		hexagons must share translational symmetry with a pointy-topped hexagon
		(turn figure~\ref{fig:wrapped-triple-tiling} \SI{30}{\degree} to verify
		this).  It follows that three triples arranged as in
